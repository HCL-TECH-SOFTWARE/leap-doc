...
11. Filters the rules shown on the left based on the field selected.

12. Changes the sort order of the rules.
...
![Rule dialog showing 'or' condition](graphics/ru_or_condition_937.png)
