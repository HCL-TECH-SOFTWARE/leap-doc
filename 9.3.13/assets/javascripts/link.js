 ...
 *   under the License.
 *
 *   The Original Code is CKEDitor 4.21.
 *
 *   The Initial Developer of the Original Code is CKSource Holding sp. z o.o
 *   Portions created by HCLSoftware are Copyright (C) 2025. All Rights Reserved.
 *
 *   Contributor(s): HCLSoftware
 */
'use strict';
					...
					children: [ {
						...
						children: [ {
							...
							items: [
								...
								// enables editor to recognize Notes and Notesdomino urls which will open in that product if encountered in a text block.
								[ 'http://\u200E', 'http://' ],
								[ 'https://\u200E', 'https://' ],
								[ 'ftp://\u200E', 'ftp://' ],
								[ 'news://\u200E', 'news://' ],
								[ 'notes://\u200E', 'notes://' ],
								[ 'notesdomino://\u200E', 'notesdomino://' ],
								[ linkLang.other, '' ]
							],
						...
						},
						{
							...
							onKeyUp: function() {
								...
								var protocolCmb = this.getDialog().getContentElement( 'info', 'protocol' ),
									url = this.getValue(),
									urlOnChangeProtocol = /^(http|https|notes|ftp|news):\/\/(?=.)/i,
