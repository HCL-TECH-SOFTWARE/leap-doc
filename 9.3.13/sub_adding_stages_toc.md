...
During the transition from one stage to the next, there are several activities that can take place: **Send an Email**, **Call a Service**, **Assign Users to a role**, and **Remove users from a role**.
...
-   **[Removing users from a role after submission](sub_removing_a_user.md)**  
You can dynamically remove a user from a role as part of a form submission.
