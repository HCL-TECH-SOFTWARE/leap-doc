...
| :------------ | :---------- | :------------ | :---------- |
| Attachment| attachment | Rich text | richTextArea |
| Button | button | Section | section |
| Check Box | checkBox | Select Many | checkGroup |
| Currency | currency | Select One | radioGroup |
| Data Grid | dataGrid | Single Line | text |
| Date | date | Survey | survey |
| Dropdown | comboBox | Survey Question | surveyQuestion |
| Email Address | emailAddress | Tabbed folder | tabFolder |
| Folder Tab | tabFolderTab | Table | aggregationListContainer |
| HTML Fragment | htmlArea | Text | richText |
| Image | image | Time | time |
| Line | horizontalLine | Timestamp | timeStamp |
| Multi-Line | textArea | Web Link | staticWebLink |
| Name Picker | name | horizontalSlider | Website | weblink |
| Number | number | | |
| Numeric Slider | | |
| Page | page |  |  |
